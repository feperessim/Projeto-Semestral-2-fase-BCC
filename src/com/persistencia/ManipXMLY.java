...
public class ManipXMLY{

	static String NOMEDOARQUIVO = "DATA_VAR_Y";
	...
	public static boolean gravarXML(List<Double> Y){		//
		// Cria o elemento que ser� o root
				...
				for (int x = 0; x < Y.size(); x++){
					Element VAR_Y = new Element("VAR_X");
					
					VAR_Y.setAttribute("N", String.valueOf(x));
					
					Element Num = new Element("x");
					Num.setText(String.valueOf(Y.get(x)));
													
					VAR_Y.addContent(Num);
					config.addContent(VAR_Y);		
				}
